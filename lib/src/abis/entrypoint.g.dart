...
class Entrypoint extends _i1.GeneratedContract {
  ...
  Future<BigInt> getNonce(
    ({_i2.Address sender, BigInt key}) args, {
    _i1.BlockNum? atBlock,
  }) async {
  ...
  Future<String> handleAggregatedOps(
    ({List<dynamic> opsPerAggregator, _i2.Address beneficiary}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<String> handleOps(
    ({List<dynamic> ops, _i2.Address beneficiary}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<BigInt> nonceSequenceNumber(
    ({_i2.Address $param20, BigInt $param21}) args, {
    _i1.BlockNum? atBlock,
  }) async {
  ...
  Future<String> simulateHandleOp(
    ({dynamic op, _i2.Address target, _i3.Uint8List targetCallData}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<String> withdrawStake(
    ({_i2.Address withdrawAddress}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<String> withdrawTo(
    ({_i2.Address withdrawAddress, BigInt withdrawAmount}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
...
class AccountDeployed {
  AccountDeployed(
    ...
    this.event,
        ...
        sender = (response[1] as _i2.Address),
        factory = (response[2] as _i2.Address),
        paymaster = (response[3] as _i2.Address);

  final _i3.Uint8List userOpHash;

  final _i2.Address sender;

  final _i2.Address factory;

  final _i2.Address paymaster;
...
class Deposited {
  Deposited(
    List<dynamic> response,
    this.event,
  )   : account = (response[0] as _i2.Address),
        totalDeposit = (response[1] as BigInt);

  final _i2.Address account;
...
class SignatureAggregatorChanged {
  SignatureAggregatorChanged(
    List<dynamic> response,
    this.event,
  ) : aggregator = (response[0] as _i2.Address);

  final _i2.Address aggregator;
...
class StakeWithdrawn {
  StakeWithdrawn(
    ...
    this.event,
        ...
        withdrawAddress = (response[1] as _i2.Address),
        amount = (response[2] as BigInt);

  final _i2.Address account;

  final _i2.Address withdrawAddress;
...
class UserOperationEvent {
  UserOperationEvent(
    ...
    this.event,
        ...
        sender = (response[1] as _i2.Address),
        paymaster = (response[2] as _i2.Address),
