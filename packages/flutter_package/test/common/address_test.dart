...
import 'mocks/basic_address_test.mocks.dart';
...
void main() {
  group('Address', () {
    ...
    final basicMockENS = BasicMockENS();
    ...
    test('can get the ENS name asynchronously', () async {
      ...
      // Simon: using my custom mockEns
      when(basicMockENS
              .withAddress('0x95222290dd7278aa3ddd389cc1e1d165cc4bafe5')
              .getName())
          .thenAnswer((_) => Future.value("test.eth"));

      Address address = Address.fromEthAddress(
          EthereumAddress.fromHex('0x95222290DD7278Aa3Ddd389Cc1E1d165CC4BAfe5'),
          ens: true);

      // Simon: @Peter, how does this Address class know about the mockEns???
      // I don't see any dependency injection here.
