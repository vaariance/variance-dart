...
const Overview = ({balances, total}: IBalanceT) => {
    ...
    return (
        <div className="max-w-2xl mx-auto p-10 space-y-5">
            <div className="border rounded-lg bg-gradient-to-r from-red-100 to-red-300">
                ...
                <div className="py-5 px-4 border-t text-right">
                    <a href="#" className="text-blue-600 hover:text-blue-500 text-sm font-medium underline">
