...
// optimizations to avoid to an from from affine and jacobian coordinates
//
...
library Secp256r1 {
   ...
   * @param q - public key coordinates
   * @param rs - R and S signature values
   * @param input - hashed message
   */
  function Verify(uint256[2] memory q, uint256 r, uint256 s, uint e) internal view returns (bool) {
